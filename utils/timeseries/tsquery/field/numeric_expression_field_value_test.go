...
func executeAndGetMetaForNumericTest(t *testing.T, f Value, ctx context.Context) (ValueMeta, error) {
...
func (ef *errorFieldForNumeric) Execute(fieldsMeta []tsquery.FieldMeta) (ValueMeta, ValueSupplier, error) {
...
func TestNumericExpressionField_IncompatibleTypes(t *testing.T) {
	...
	expr := NewNumericExpressionFieldValue(field1, BinaryNumericOperatorAdd, field2)
...
func TestNumericExpressionField_ModuloOnlyForIntegers(t *testing.T) {
	...
	expr := NewNumericExpressionFieldValue(field1, BinaryNumericOperatorMod, field2)
	_, _, err := expr.Execute([]tsquery.FieldMeta{})
	require.Error(t, err)
...
func TestNumericExpressionField_ComplexExpressions(t *testing.T) {
	...
	// First create 10 + 5
	expr1 := NewNumericExpressionFieldValue(field1, BinaryNumericOperatorAdd, field2)

	// Then multiply by 2
	expr2 := NewNumericExpressionFieldValue(expr1, BinaryNumericOperatorMul, field3)
