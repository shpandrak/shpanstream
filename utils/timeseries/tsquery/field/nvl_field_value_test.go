...
func executeFieldValueMeta(t *testing.T, f Value, ctx context.Context) (ValueMeta, error) {
...
func (ef *errorField) Execute(fieldsMeta []tsquery.FieldMeta) (ValueMeta, ValueSupplier, error) {
	valueMeta := ValueMeta{
...
func TestNvlField_SourceHasValue(t *testing.T) {
	...
	requiredMeta := ValueMeta{DataType: tsquery.DataTypeInteger, Required: true}
...
func TestNvlField_SourceRequired(t *testing.T) {
	...
	requiredMeta1 := ValueMeta{DataType: tsquery.DataTypeInteger, Required: true}
	requiredMeta2 := ValueMeta{DataType: tsquery.DataTypeInteger, Required: true}
...
func TestNvlField_DifferentDataTypes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			sourceMeta := ValueMeta{DataType: tt.sourceType, Required: false}
			altMeta := ValueMeta{DataType: tt.altType, Required: true}
...
func TestNvlField_AlternativeNotRequired(t *testing.T) {
	sourceMeta := ValueMeta{DataType: tsquery.DataTypeInteger, Required: false}
	altMeta := ValueMeta{DataType: tsquery.DataTypeInteger, Required: false}
...
func TestNvlField_Meta(t *testing.T) {
	ctx := context.Background()
	sourceMeta := ValueMeta{DataType: tsquery.DataTypeInteger, Required: false}
	altMeta := ValueMeta{DataType: tsquery.DataTypeInteger, Required: true}
...
func TestNvlField_AllDataTypes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			sourceMeta := ValueMeta{DataType: tt.dataType, Required: false}
			altMeta := ValueMeta{DataType: tt.dataType, Required: true}
...
func TestNvlField_CombinedWithOperations(t *testing.T) {
	...
	sumField := NewNumericExpressionFieldValue(nvlField, BinaryNumericOperatorAdd, constantFive)
