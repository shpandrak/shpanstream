...
func (p CustomPluginParser) ParseReportFilter(_ *ParsingContext, filter ApiReportFilter) (report.Filter, error) {
	return nil, fmt.Errorf("no custom report filter types supported")
}
