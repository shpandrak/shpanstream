...
// a Helper function to create a constant field with a given datatype and value
func createConstantField(dataType tsquery.DataType, value any) report.Value {
	valueMeta := tsquery.ValueMeta{DataType: dataType, Required: true}
	return report.NewConstantFieldValue(valueMeta, value)
}
...
func TestConditionFilter_GreaterThan_Decimal(t *testing.T) {
	...
	threshold := createConstantField(tsquery.DataTypeDecimal, 20.0)
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
		tempField,
		threshold,
	)
...
func TestConditionFilter_GreaterThan_Integer(t *testing.T) {
	...
	requestsField := report.NewRefFieldValue("CounterMetrics:Requests")
	threshold := createConstantField(tsquery.DataTypeInteger, int64(300))
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
		requestsField,
		threshold,
	)
...
func TestConditionFilter_LessThan_Decimal(t *testing.T) {
	...
	tempField := report.NewRefFieldValue("SensorReading:Temperature")
	threshold := createConstantField(tsquery.DataTypeDecimal, 20.0)
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorLessThan,
		tempField,
		threshold,
	)
...
func TestConditionFilter_GreaterEqual_Integer(t *testing.T) {
	...
	requestsField := report.NewRefFieldValue("CounterMetrics:Requests")
	threshold := createConstantField(tsquery.DataTypeInteger, int64(200))
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterEqual,
		requestsField,
		threshold,
	)
...
func TestConditionFilter_LessEqual_Decimal(t *testing.T) {
	...
	tempField := report.NewRefFieldValue("SensorReading:Temperature")
	threshold := createConstantField(tsquery.DataTypeDecimal, 20.0)
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorLessEqual,
		tempField,
		threshold,
	)
...
func TestConditionFilter_Equals_Integer(t *testing.T) {
	...
	requestsField := report.NewRefFieldValue("CounterMetrics:Requests")
	target := createConstantField(tsquery.DataTypeInteger, int64(100))
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorEquals,
		requestsField,
		target,
	)
...
func TestConditionFilter_CompareTwoFields(t *testing.T) {
	...
	requestsField := report.NewRefFieldValue("CounterMetrics:Requests")
	errorsField := report.NewRefFieldValue("CounterMetrics:Errors")
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
		requestsField,
		errorsField,
	)
...
func TestConditionFilter_NoMatchingRows(t *testing.T) {
	...
	tempField := report.NewRefFieldValue("SensorReading:Temperature")
	threshold := createConstantField(tsquery.DataTypeDecimal, 100.0)
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
		tempField,
		threshold,
	)
...
func TestConditionFilter_Equals_String(t *testing.T) {
	...
	statusField := report.NewRefFieldValue("ApplicationStatus:Status")
	target := createConstantField(tsquery.DataTypeString, "running")
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorEquals,
		statusField,
		target,
	)
...
func TestConditionFilter_Equals_Boolean(t *testing.T) {
	...
	activeField := report.NewRefFieldValue("ApplicationStatus:Active")
	target := createConstantField(tsquery.DataTypeBoolean, true)
	conditionField := report.NewConditionFieldValue(tsquery.ConditionOperatorEquals,
		activeField,
		target,
	)
...
func TestLogicalExpressionFilter_And_BothTrue(t *testing.T) {
	...
	tempField := report.NewRefFieldValue("SensorReading:Temperature")
	humidityField := report.NewRefFieldValue("SensorReading:Humidity")

	tempThreshold := createConstantField(tsquery.DataTypeDecimal, 20.0)
	humidityThreshold := createConstantField(tsquery.DataTypeDecimal, 60.0)

	tempCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
		tempField,
		tempThreshold,
	)

	humidityCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
		humidityField,
		humidityThreshold,
	)

	andCondition := report.NewLogicalExpressionFieldValue(tsquery.LogicalOperatorAnd,
		tempCondition,
		humidityCondition,
	)
...
func TestLogicalExpressionFilter_Or_AtLeastOneTrue(t *testing.T) {
	...
	orCondition := report.NewLogicalExpressionFieldValue(tsquery.LogicalOperatorOr,
		tempCondition,
		humidityCondition,
	)
...
func TestLogicalExpressionFilter_And_WithIntegerFields(t *testing.T) {
	...
	requestsThreshold := createConstantField(tsquery.DataTypeInteger, int64(500))
	errorsThreshold := createConstantField(tsquery.DataTypeInteger, int64(10))

	requestsCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
		requestsField,
		requestsThreshold,
	)

	errorsCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorLessThan,
		errorsField,
		errorsThreshold,
	)
...
func TestLogicalExpressionFilter_NestedLogicalExpressions(t *testing.T) {
	...
	requestsThreshold := createConstantField(tsquery.DataTypeInteger, int64(500))
	errorsThreshold := createConstantField(tsquery.DataTypeInteger, int64(10))
	zeroErrors := createConstantField(tsquery.DataTypeInteger, int64(0))
	...
	lowErrorsCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorLessThan,
		errorsField,
		errorsThreshold,
	)

	zeroErrorsCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorEquals,
		errorsField,
		zeroErrors,
	)
...
func TestLogicalExpressionFilter_And_AllTrue(t *testing.T) {
	...
	// Apply condition filter
	filteredResult, err := report.NewConditionFilter(report.NewLogicalExpressionFieldValue(tsquery.LogicalOperatorAnd,
		report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
			tempField,
			createConstantField(tsquery.DataTypeDecimal, 20.0),
		),
		report.NewConditionFieldValue(tsquery.ConditionOperatorGreaterThan,
			humidityField,
...
func TestLogicalExpressionFilter_WithStringAndBooleanComparisons(t *testing.T) {
	...
	runningValue := createConstantField(tsquery.DataTypeString, "running")
	trueValue := createConstantField(tsquery.DataTypeBoolean, true)

	statusCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorEquals,
		statusField,
		runningValue,
	)

	activeCondition := report.NewConditionFieldValue(tsquery.ConditionOperatorEquals,
		activeField,
		trueValue,
	)
