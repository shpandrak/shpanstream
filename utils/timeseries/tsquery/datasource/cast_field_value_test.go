...
func executeAndGetValue(f Value, ctx context.Context) (any, error) {
...
func TestCastField_IntegerToDecimal(t *testing.T) {
	...
	result, err := executeAndGetValue(castField, ctx)
...
func TestCastField_ErrorPropagation(t *testing.T) {
	...
	_, err := executeAndGetValue(castField, ctx)
	require.Error(t, err)
...
func TestCastField_ChainedCasts(t *testing.T) {
	...
	result, err := executeAndGetValue(castToDecimal, ctx)
	require.NoError(t, err)
	require.Equal(t, float64(42), result)
}
...
func (ef *testErrorField) Execute(_ context.Context, _ tsquery.FieldMeta) (tsquery.ValueMeta, ValueSupplier, error) {
