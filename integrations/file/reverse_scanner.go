...
var (
	ErrTooLong         = errors.New("reverse.Scanner: token too long")
	ErrNegativeAdvance = errors.New("reverse.Scanner: SplitFunc returns negative advance count")
	ErrAdvanceTooFar   = errors.New("reverse.Scanner: SplitFunc returns advance count beyond input")
	ErrBadReadCount    = errors.New("reverse.Scanner: Read returned impossible count")
)

const defaultBufSize = 4096
const defaultMaxConsecutiveEmptyReads = 100

func NewReverseScanner(r io.ReaderAt, readerSize int64) *Scanner {
